...
public class SubtractionOperation extends MultiMatrixOperation {
    ...
    // EFFECTS:  Attempts to perform matrix subtraction between matrices A and B.
    //           If the subtraction is successful, returns the resulting matrix.
    //           If the dimensions of A and B are incompatible for subtraction, 
    ...
    public double[][] performOperation(double[][] A, double[][] B, MultiMatrixOperation operation) {
        try {
            ...
            double[][] result = calculationFunctions.subtraction(A, B);
