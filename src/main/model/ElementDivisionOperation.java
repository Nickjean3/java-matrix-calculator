...
public class ElementDivisionOperation extends MultiMatrixOperation {
    ...
    // EFFECTS:  Attempts to perform element-wise matrix division between matrices A and B.
    //           If the division is successful, returns the resulting matrix.
    //           If the dimensions of A and B are incompatible for division, 
