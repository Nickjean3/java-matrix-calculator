...
public class AdditionOperation extends MultiMatrixOperation {
    ...
    // EFFECTS:  Attempts to perform matrix addition between matrices A and B.
    //           If the addition is successful, returns the resulting matrix.
    //           If the dimensions of A and B are incompatible for addition, throws an IncorrectMatrixDimensionsException.
    ...
    public double[][] performOperation(double[][] A, double[][] B, MultiMatrixOperation operation) {
        ...
        try {
            ...
            double[][] result = calculationFunctions.addition(A, B);
