...
public class MultiplicationOperation extends MultiMatrixOperation {
    ...
    // EFFECTS:  Attempts to perform matrix multiplication between matrices A and B.
    ...
    public double[][] performOperation(double[][] A, double[][] B, MultiMatrixOperation operation) {
        try {
            ...
            double[][] result = calculationFunctions.multiplication(A, B);
